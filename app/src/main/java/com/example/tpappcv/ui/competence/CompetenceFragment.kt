...
private var _binding: FragmentCompetenceBinding? = null
  ...
  override fun onCreateView(
    ...
    val competenceViewModel =
            ViewModelProvider(this).get(CompetenceViewModel::class.java)

    _binding = FragmentCompetenceBinding.inflate(inflater, container, false)
    val root: View = binding.root

    val textView: TextView = binding.textCompetence
    competenceViewModel.text.observe(viewLifecycleOwner) {
      textView.text = it
    }
    return root
  }
